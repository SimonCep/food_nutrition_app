          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                ...
                alignItems: "center",
                borderColor: "#ccc",
                backgroundColor: weightLossChecked ? "#3182CE" : "#fff",
              }}
            >
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                ...
                alignItems: "center",
                borderColor: "#ccc",
                backgroundColor: veganChecked ? "#3182CE" : "#fff",
              }}
            >
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                ...
                alignItems: "center",
                borderColor: "#ccc",
                backgroundColor: vegetarianChecked ? "#3182CE" : "#fff",
              }}
            >
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                ...
                alignItems: "center",
                borderColor: "#ccc",
                backgroundColor: diseaseSpecificChecked ? "#3182CE" : "#fff",
              }}
            >
              {diseaseSpecificChecked && (
